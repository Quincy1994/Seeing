...
import learnNeo.DanDing.MyRelationshipTypes;
...
public class CreateGraph {
	...
	public static void main(String[] args) throws IOException{
		File file = new File("/home/yingying/下载/newMovie");
		File[] fileList = file.listFiles();
		int x = 0;
		for(; x <fileList.length; x ++){
			String txtPath = fileList[x].getAbsolutePath();			
			String[]  fileNameArray = txtPath.split("/");
			String fileName = fileNameArray[fileNameArray.length -1];
			String txtAbsoPath = txtPath + "/" + fileName + ".txt";
			//System.out.println(txtPath+ "/" + fileName + ".txt");
			CreateGraph graph = new CreateGraph("/home/yingying/桌面/newGraph/" + fileName, txtAbsoPath);
	}
		//CreateGraph graph = new CreateGraph("/home/yingying/乘风破浪1", "/home/yingying/乘风破浪/乘风破浪.txt");
	}
}
